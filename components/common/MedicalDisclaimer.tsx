...
const COPY = {
  ko: {
    label: "의료 안내",
    compact:
      "이 페이지는 가정에서 참고하기 좋은 일반 정보예요. 진단·치료·약 복용·접종 결정은 반드시 소아청소년과 등 의료진과 상의해 주세요.",
    fullTitle: "병원 진료를 대신하지 않는 참고용 정보예요",
    fullParagraphs: [
      "MomTools의 계산기, 정보 글, 체크리스트는 부모가 집에서 흐름을 정리하고 다음 단계를 준비하는 데 도움을 주는 일반 참고용 자료예요.",
      "아이의 진단, 치료, 약 복용 여부, 접종 가능 여부, 발달 이상 여부처럼 개별 건강 상태와 직결된 판단은 의료기관과 의료진을 통해 확인하셔야 해요.",
