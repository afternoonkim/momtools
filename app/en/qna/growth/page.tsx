...
export const metadata: Metadata = {
  title: "Growth Questions | Parent Q&A",
  description: "These answers focus on sleep and development questions parents ask most often, including bedtime routines, naps, milestones, language, crawling, walking, and healthy growth patterns.",
    ...
    <div className="mt-page">
      <div className="mt-container space-y-8">
        <section className="mt-card p-8 md:p-10">
          ...
          <p className="mt-text-main mt-4 max-w-4xl">These answers focus on sleep and development questions parents ask most often, including bedtime routines, naps, milestones, language, crawling, walking, and healthy growth patterns.</p>
