...
export const metadata: Metadata = {
  title: "Health Questions | Parent Q&A",
  description: "These answers cover common health and feeding questions, from fever and rashes to solids, constipation, spit-up, and hydration. They are written to help parents decide what to watch at home and when medical advice is a better next step.",
    ...
    <div className="mt-page">
      <div className="mt-container space-y-8">
        <section className="mt-card p-8 md:p-10">
          ...
          <p className="mt-text-main mt-4 max-w-4xl">These answers cover common health and feeding questions, from fever and rashes to solids, constipation, spit-up, and hydration. They are written to help parents decide what to watch at home and when medical advice is a better next step.</p>
