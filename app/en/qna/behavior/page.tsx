...
export const metadata: Metadata = {
  title: "Behavior Questions | Parent Q&A for U.S. families",
  description:
    "Questions parents search about crying, separation anxiety, tantrums, biting, routines, self-soothing, and daycare transitions.",
  keywords: ["toddler behavior questions", "parent q&a", "baby questions", "U.S. parenting"],
      ...
      <div className="mt-container space-y-8">
        <section className="mt-card p-8 md:p-10">
          ...
          <p className="mt-text-main mt-4 max-w-4xl">
            Questions parents search about crying, separation anxiety, tantrums, biting, routines,
            self-soothing, and daycare transitions.
          </p>
        ...
        <section className="mt-card-soft p-6 md:p-8">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-3">
            ...
            <Link href="/en/checklists/daycare" className="rounded-2xl bg-white px-5 py-5 shadow-sm font-semibold text-slate-800">
              Daycare checklist
            </Link>
