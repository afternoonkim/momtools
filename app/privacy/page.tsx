...
export const metadata: Metadata = {
  title: "개인정보처리방침",
  description:
    "MomTools 개인정보처리방침 페이지입니다. 수집 가능한 정보, 이용 목적, 쿠키, 외부 서비스, 보유 기간, 이용자 권리, 아동 관련 정보 처리 기준을 확인할 수 있습니다.",
};
      ...
      <div className="mt-container-narrow space-y-8">
        <section className="mt-card p-8 md:p-10">
          ...
          <p className="mt-text-main mt-4">
            ...
            있는지, 왜 필요한지, 외부 서비스가 어떤 방식으로 연결될 수 있는지,
        ...
        <section className="mt-card-soft p-6 md:p-8">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-2xl border border-slate-100 bg-white p-5 text-sm leading-7 text-slate-600">
              문의, 기본적인 방문 기록, 외부 페이지 이동 과정에서 일부 정보가 제한적으로
              처리될 수 있습니다.
            </div>
            <div className="rounded-2xl border border-slate-100 bg-white p-5 text-sm leading-7 text-slate-600">
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-2">
            ...
            >
              ...
              <div className="mt-2 text-sm leading-7 text-slate-500">
                서비스 이용 범위, 면책 기준, 외부 링크와 콘텐츠 이용 원칙을 확인할 수
                있어요.
              </div>
            </Link>
