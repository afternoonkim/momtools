...
const sections = [
  {
    ...
    paragraphs: [
      ...
      "사이트는 회원가입 없이 이용할 수 있는 기능을 기본으로 하며, 로그인 후 내 아이 홈과 발달 체크를 이용할 때도 아이의 애칭, 생년월일, 성별, 필요한 경우 출산 예정일, 보호자가 직접 남긴 발달 체크 기록처럼 맞춤 안내에 필요한 범위의 정보만 저장합니다.",
    ],
  },
  {
    title: "2. 수집될 수 있는 정보",
    ...
    bullets: [
      ...
      "카카오 로그인을 이용할 때 제공되는 카카오 계정 식별값, 선택 동의한 이메일, 닉네임, 프로필 이미지",
      "내 아이 홈과 발달 체크 이용을 위해 보호자가 직접 입력한 아이 애칭, 생년월일, 선택한 성별, 이른둥이 교정 월령 확인을 위해 보호자가 직접 입력한 출산 예정일",
      "아이별 발달 체크에서 보호자가 직접 선택한 체크 상태와 짧은 관찰 메모",
  ...
  },
  {
    ...
    bullets: [
      ...
      "로그인 상태 유지와 아이 애칭, 생년월일, 성별과 필요한 경우 출산 예정일을 바탕으로 한 내 아이 기준 월령, 예방접종, 이유식, 체크리스트 안내 제공",
      "아이별 발달 체크 기록을 저장해 보호자가 이전 관찰 흐름을 다시 확인할 수 있도록 제공",
  ...
  {
    title: "5. 광고와 제휴 링크 안내",
    paragraphs: [
      "MomTools는 사이트 운영을 위해 카카오 애드핏 광고와 쿠팡 파트너스 제휴 링크를 표시할 수 있습니다.",
      "광고와 제휴 링크는 페이지 주제와 가까운 정보를 함께 보여주기 위한 용도로 사용되며, 외부 광고 또는 쇼핑몰로 이동한 뒤의 개인정보 처리와 구매 과정은 해당 서비스의 정책이 적용됩니다.",
      "쿠팡 파트너스 링크를 통해 구매가 이루어질 경우 MomTools는 일정액의 수수료를 제공받을 수 있습니다. 다만 상품의 가격, 배송, 교환·환불, 안전성은 판매처의 최신 정보를 기준으로 확인해야 합니다.",
      "광고 표시와 관련된 쿠키 또는 유사 기술은 브라우저 설정에서 차단하거나 삭제할 수 있습니다. 다만 이 경우 일부 외부 광고 표시가 정상적으로 동작하지 않을 수 있습니다.",
    ],
  },
  {
    title: "6. 외부 서비스 연동",
    paragraphs: [
      "사이트에는 지도, 외부 쇼핑몰, 공공 안내 링크, 참고 자료처럼 이용 편의를 위한 외부 연결이 포함될 수 있습니다.",
  ...
  },
  {
    ...
    paragraphs: [
      "사이트는 육아 정보를 다루지만, 내 아이 홈과 발달 체크에서는 보호자가 직접 입력한 아이 애칭, 생년월일, 성별, 필요한 경우 출산 예정일, 아이별 체크 상태와 짧은 관찰 메모를 맞춤 화면 제공에 사용합니다.",
      "아이 애칭은 실명이 아니어도 되며, '첫째', '우리 아이'처럼 보호자가 알아보기 쉬운 이름으로 입력할 수 있습니다.",
      "MomTools는 아이 주민등록번호, 주소, 연락처, 사진, 진료기록, 상세 건강정보를 요구하지 않습니다.",
      "문의 시에도 아이의 실명, 연락처, 진료기록, 사진, 상세 건강정보처럼 식별 가능성이 높은 민감한 정보는 입력하지 않도록 권장합니다.",
      ...
      <div className="mt-container-narrow space-y-8">
        <section className="mt-card p-8 md:p-10">
          ...
          <div className="mt-6 rounded-2xl border border-amber-100 bg-amber-50 px-4 py-4 text-sm text-slate-600">
            시행일: 2026-04-09 · 최근 개정: 2026-07-02
          </div>
        </section>
        ...
        <section className="mt-card-soft p-6 md:p-8">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl border border-slate-100 bg-white p-5 text-sm leading-7 text-slate-600">
              내 아이 홈과 발달 체크는 아이의 애칭, 생년월일, 성별, 필요한 경우 출산 예정일, 보호자가 직접 남긴 짧은 관찰 기록으로 이용하며,
              주민등록번호·주소·연락처·사진·진료기록은 요구하지 않습니다.
            </div>
            <div className="rounded-2xl border border-slate-100 bg-white p-5 text-sm leading-7 text-slate-600">
              카카오 애드핏 광고와 쿠팡 파트너스 제휴 링크가 표시될 수 있으며,
              외부 서비스로 이동한 뒤에는 해당 서비스의 정책이 적용됩니다.
            </div>
            <div className="rounded-2xl border border-slate-100 bg-white p-5 text-sm leading-7 text-slate-600">
